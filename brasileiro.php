	        	...
	        	<div style="clear:both; margin: 0 5px;">
					<div style="margin-bottom: 10px;">
						...
						<?php
							...
							{
								echo '<img class="photo" alt="No Image" style="-moz-border-radius:4px; background-color: #FFFFFF; border:1px solid #E3E3E3; margin: 10px 0 10px 0; padding:5px;" src="' . CN_IMAGE_BASE_URL . 'default.png" />' . "\n";
							}
						?>
					</div>
