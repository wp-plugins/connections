    ...
    <tr>
        <td align="left" class="left" width="50%" valign="top">
        	<div style="clear:both; margin: 0 5px;">
				...
				{
					echo '<img class="photo" alt="Photo of ' . $entry->getFirstName() . ' ' . $entry->getLastName() . '" style="-moz-border-radius:4px; background-color: #FFFFFF; border:1px solid #E3E3E3; padding:5px;" src="' . CN_IMAGE_BASE_URL . $entry->getImageNameCard() . '" />';
				}
				?>
			</div>
