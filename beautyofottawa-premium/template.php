<div class="cn-entry premium">
<table border="0px" cellspacing="0px" cellpadding="0px">
    <tr>
        <td align="left" width="33%" valign="top" class="left">
		...
		<td align="left" width="33%" valign="top"  class="middle">
			<p><span class="cn-label">Products and Services</span></p>
        	<?php echo $entry->getBioBlock(); ?>
        </td>
		
		<td align="left" width="33%" valign="top" class="right">
			<?php
