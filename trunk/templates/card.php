<div class='cnitem' id='cn" <?php echo $entry->getId() ?> "' style='-moz-border-radius:4px; background-color:#FFFFFF; border:1px solid #E3E3E3; margin:8px 0px; padding:6px; position: relative;'>
	<div style='width:49%; float:left'>
		...
		<div align='right' >
			...
			<?php echo $entry->getBirthdayBlock() ?>
			<?php echo $entry->getAnniversaryBlock() ?>
			
			<?php if (!$atts['id']) echo "<br /><span style='" . $entry->getLastUpdatedStyle() . "; font-size:x-small; font-variant: small-caps; position: absolute; right: 26px; bottom: 8px;'>Updated " . $entry->getLastUpdated() . " ago</span><span style='position: absolute; right: 3px; bottom: 5px;'><a href='#connections-list-head' title='Return to top.'><img src='" . WP_PLUGIN_URL . "/connections/images/uparrow.gif' /></a></span><br />\n"; ?>
			<?php if ($atts['id']) echo "<br /><span style='" . $entry->getLastUpdatedStyle() . "; font-size:x-small; font-variant: small-caps; position: absolute; right: 6px; bottom: 8px;'>Updated " . $entry->getLastUpdated() . " ago</span><br />\n"; ?>
		</div>
